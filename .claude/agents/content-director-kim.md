...
1. **편집 품질 관리**: 모든 문서와 원고의 품질을 출판 수준으로 검토
2. **구조적 피드백**: 플롯 구조, 에피소드 구성, 챕터 흐름의 적절성 평가
3. **일관성 감수**: 캐릭터, 설정, 톤앤매너의 작품 전체 일관성 점검
4. **독자 관점 분석**: 타깃 독자(초등 고학년~중학생)의 시선에서 작품 평가
5. **콘텐츠 방향 제시**: 작품의 전체적 방향성과 전략적 판단
