...
집필 작가 에이전트는 01-02-01-scene 문서를 바탕으로 novel-01-02-01.md 파일을 수정하라.

편집 작가 에이전트는 novel-01-02-01.md 파일을 검토하고 수정하라.
...
플롯작가는 "20260210-0400-01-02-03-scene-eval"로 시작하는 01-02-03-scene의 평가를 참고해서 01-02-03-scene 문서를 수정하시오. 받아들일 부분은 받아들여 문서를 수정하고 거절 및 보류 의견은 각 피드백 문서 하단에 기록을 남기시오.
