...
### 전통 문화
- **구름산 할아버지와 불꽃 도령 전설**: 마을에 전해 내려오는 구전 설화. 옛날 구름골에 큰 가뭄이 들었을 때 구름산에서 흰 수염의 신비한 할아버지가 내려와 도술을 부리자 불꽃 도령이 나타나 비를 내리고 땅을 기름지게 만들어주었다고 전함. 이후에도 여러 차례 마을을 도운 뒤, 떠나면서 "꽃이 피는 돌 아래 보물을 숨겨두었으니, 마을에 다시 위기가 찾아오면 찾으라. 단, 욕심 없는 자만이 그 상자를 열 수 있으리라"라는 말을 남김. 불꽃 도령의 정체는 전설 안에서도 명확하지 않으며, 이후 도깨비 두루/Duru와의 연결이 암시됨
